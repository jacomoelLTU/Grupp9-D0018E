...
// if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $sql_queryProduct = "INSERT into product (product_postid, product_price, product_quantity, product_title) VALUES ($maxID, $product_price, $product_quantity, $post_title)";
